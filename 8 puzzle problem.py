...
def solve_8_puzzle(start, goal):
    # Precompute goal positions for O(1) lookups in the heuristic
...
def heuristic(state, goal_pos):
    """
    Computes the Manhattan distance heuristic using a precomputed map of goal positions.
    This avoids an O(N^2) nested loop over the goal state for each cell.
    """
