...
def solve_8_puzzle(start, goal):
    # Pre-calculate goal positions for O(1) heuristic lookups
    goal_pos = {
        gval: (gi, gj)
    ...
    open_list = []
    # Initialize with proper f = g + h value for the start state
    initial_cost = 0 + heuristic(start, goal_pos)
    heappush(open_list, (initial_cost, start, []))
