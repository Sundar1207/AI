...
def solve_8_puzzle(start, goal):
    # ⚡ Bolt Optimization: Precompute goal positions for O(1)
    # lookup in heuristic.
    # This replaces a 4-deep nested loop (O(N^4)) with O(1) position lookups.
...
def heuristic(state, goal_pos):
    # ⚡ Bolt Optimization: Calculate Manhattan distance using O(1)
    # goal position lookups
    h = 0
